...
config <- list(
  n.iter  = 5000,  # number of iterations between convergence checks.
  use.n.iter = 1000, #sample size for testing for convergence. 
  ...
  max.iter=300000, # maximum steps for each chain (without thining). MCMC will be stoped if the chain reached max.iter iterations (convergence criterium is ignored)
